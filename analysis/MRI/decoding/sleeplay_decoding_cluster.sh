...
PATH_SCRIPT="${PATH_REPO}/b_loc_v2/analysis/MRI/decoding/sleeplay_decoding.py"
# path to the log directory:
PATH_LOG="${PATH_BASE}/${PROJECT_NAME}/b_loc_v2/logs/decoding"
...
for SUB in ${SUB_LIST[@]}; do
	...
	#SUB_PAD=$(printf "%02d\n" ${SUB})
	# Get job name
	JOB_NAME="sleeplay_decoding_sub-${SUB}" #SUB_PAD
	# Create job file
	...
	# write to log folder
	echo "#SBATCH --output ${PATH_LOG}/log_decoding_sub-${SUB}.%j.out" >> job.slurm
