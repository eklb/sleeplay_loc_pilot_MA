...
PATH_SCRIPT="${PATH_REPO}/b_loc_v2/analysis/MRI/decoding/sleeplay_searchlight.py"
...
for SUB in ${SUB_LIST[@]}; do
	...
	#SUB_PAD=$(printf "%02d\n" ${SUB})
	# Get job name
	JOB_NAME="sleeplay_searchlight_sub-${SUB}" #SUB_PAD
	# Create job file
	...
	echo "#SBATCH --time 240:00:00" >> job.slurm 
	...
	# write to log folder
	echo "#SBATCH --output ${PATH_LOG}/log_searchlight_sub-${SUB}.%j.out" >> job.slurm
