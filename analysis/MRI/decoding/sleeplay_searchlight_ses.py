...
#%% SAVE OUTPUT MAPS
    ...
    sl_map_savename =  f"Searchlight-AccMap_{sub}_{ses}_{cue_type}_{smooth_suffix}.nii"
    
    if MNI:
        sl_map_savename =  f"Searchlight-AccMap_{sub}_{ses}_{cue_type}_MNI_{smooth_suffix}.nii"
